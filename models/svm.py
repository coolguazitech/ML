...
class SVM:
    def __init__(self, n_iter=1000, lr=0.001, c=1.0):
        """ Naive soft margin support vector machine implementation
...
if __name__ == '__main__':
    # test
    X, y = datasets.make_blobs(n_samples=100, n_features=2, centers=2, cluster_std=3.0, random_state=124)
    ...
    plt.xlabel('x')
    plt.ylabel('y')
    plt.scatter(X_train_std[:, 0], X_train_std[:, 1], c=(y_train * 50 + 50).astype(int))
